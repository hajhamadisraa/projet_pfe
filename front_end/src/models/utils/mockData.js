...
export const MOCK_ALERTS = [
  // ── Demandes de compte (account) — en premier pour visibilité admin
  {
    id: 'al_acc1',
    title: 'Nouvelle demande de compte',
    location: 'Inscription',
    description: 'Karim Benali (karim@poulia.com) souhaite créer un compte éleveur.',
    severity: ALERT_SEVERITY.WARNING,
    category: ALERT_CATEGORIES.ACCOUNT,
    timestamp: '5m ago',
    read: false,
    meta: { userId: 'u5', userName: 'Karim Benali', userEmail: 'karim@poulia.com' },
  },
  {
    id: 'al_acc2',
    title: 'Nouvelle demande de compte',
    location: 'Inscription',
    description: 'Fatima Ouhabi (fatima@poulia.com) souhaite créer un compte éleveur.',
    severity: ALERT_SEVERITY.WARNING,
    category: ALERT_CATEGORIES.ACCOUNT,
    timestamp: '1h ago',
    read: false,
    meta: { userId: 'u6', userName: 'Fatima Ouhabi', userEmail: 'fatima@poulia.com' },
  },
  // ── Alertes système existantes
  {
    ...
    description: 'Internal temperature reached 34°C. Ventilation fans failing.',
  ...
  },
  {
    ...
    location: 'North Wing',
    description: 'Water intake dropped by 15% in the last 2 hours.',
    severity: ALERT_SEVERITY.WARNING,
  ...
  },
  {
    ...
    description: 'Heating unit reported FAIL status.',
    severity: ALERT_SEVERITY.CRITICAL,
    category: ALERT_CATEGORIES.SYSTEM,
    timestamp: '3h ago',
    read: true,
...
export const MOCK_USERS = [
  ...
  },
  {
    ...
    isActive: true,
    assignedCoops: [
      { id: 'coop1', name: 'Coop Delta-4' },
      { id: 'coop3', name: 'Coop Sigma-9' },
    ],
  },
  {
    id: 'u3',
    name: 'Antoine Dubois',
    email: 'lecteur@poulia.com',
    role: 'LECTEUR',
  ...
  // ── Comptes en attente de validation
  {
    id: 'u5',
    name: 'Karim Benali',
    email: 'karim@poulia.com',
    role: 'OPÉRATEUR',
    roleBadgeType: 'OPERATOR',
    status: 'PENDING',
    sector: null,
    lastSeen: 'Demande le 09/05/2026',
    isOnline: false,
    isActive: false,
    assignedCoops: [],
  },
  {
    id: 'u6',
    name: 'Fatima Ouhabi',
    email: 'fatima@poulia.com',
    role: 'OPÉRATEUR',
    roleBadgeType: 'OPERATOR',
    status: 'PENDING',
    sector: null,
    lastSeen: 'Demande le 08/05/2026',
    isOnline: false,
    isActive: false,
    assignedCoops: [],
  },
